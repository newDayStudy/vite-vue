  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      (s.VERSION = "2.5.0"),
        ...
        n(document).on("changed.dom.amui", (t) => {
          var e = t.target;
          n.each(s.DOMWatchers, (t, i) => {
            i(e);
          });
        }),
        n(() => {
      ...
      (X.prototype = {
        ...
        recognize(t) {
          ...
          return u(this.options.enable, [this, e])
            ? (this.state & (ce | ue | he) && (this.state = oe),
              (this.state = this.process(e)),
              void (this.state & (ae | re | le | ue) && this.tryEmit(e)))
        ...
        l(J, G, {
          ...
          attrTest(t) {
            return (
              G.prototype.attrTest.call(this, t) &&
              (this.state & ae || (!(this.state & ae) && this.directionTest(t)))
            );
          },
          emit(t) {
        ...
        l(Q, X, {
          ...
          process(t) {
            ...
            if (
              ((this._input = t), !s || !i || (t.eventType & (Dt | Ft) && !o))
            )
              this.reset();
        ...
        l(tt, G, {
          ...
          attrTest(t) {
            return (
              this._super.attrTest.call(this, t) &&
              (Math.abs(t.rotation) > this.options.threshold || this.state & ae)
            );
          },
        }),
        l(et, G, {
        ...
        recognize(t) {
          ...
          if (!e.stopped) {
            ...
            for (var o = 0; o < n.length; )
              (i = n[o]),
                e.stopped === pe || (s && i != s && !i.canRecognizeWith(s))
                  ? i.reset()
                  : i.recognize(t),
      ...
      (o.DEFAULTS = {
        ...
        (o.prototype.toggle = function () {
          ...
          if (i.length) {
            ...
            "radio" == n.prop("type") &&
              (n.prop("checked") && e.hasClass("am-active")
                ? (t = !1)
                : i.find(".am-active").removeClass("am-active")),
              t &&
                n.prop("checked", !e.hasClass("am-active")).trigger("change");
          }
          t &&
            (e.toggleClass("am-active"), e.hasClass("am-active") || e.blur());
        }),
        s.plugin("button", o, {
    ...
    function (t, e, i) {
      ...
      (a.DEFAULTS = {
        ...
        (a.prototype.open = function (t) {
          ...
          var e = this;
          o.on("mousedown.datapicker.amui touchstart.datepicker.amui", (t) => {
        ...
        (r.prototype.init = function () {
          return (
            this.inited ||
              ...
              this.$element.on("touchmove.dimmer.amui", (t) => {
                t.preventDefault();
              })),
            this
          );
          ...
          if (this.active) {
            ...
            o
              ? (i.removeClass(this.options.animation),
                i.addClass(t),
                (this.animating = 1),
                i.one(o.end + ".close.dropdown.amui", () => {
                  i.removeClass(t), s();
                }))
              : s();
          }
            ...
            var t = this.$dropdown,
              ...
              o =
                n.isWindow(this.boundary) && this.$boundary.offset()
                  ...
                  : 0;
            this.$justify && t.css({ "min-width": this.$justify.css("width") }),
              i + (e.left - o) > s &&
    ...
    function (t, e, i) {
      (function (e) {
        ...
        (n.flexslider = function (t, i) {
              ...
              init() {
                (s.animating = !1),
                  ...
                  s.vars.slideshow &&
                    ...
                    (s.vars.pauseInvisible && v.pauseInvisible.isHidden()) ||
                      (s.vars.initDelay > 0
                  ...
                  (!m || (m && s.vars.smoothHeight)) &&
                    n(window).bind("resize orientationchange focus", v.resize),
                  ...
                  (s.asNav = !0),
                    ...
                    r
                      ...
                      : s.slides.on(c, function (t) {
                          ...
                          0 >= o && e.hasClass(a + "active-slide")
                            ? s.flexAnimate(s.getTarget("prev"), !0)
                            : n(s.vars.asNavFor).data("flexslider").animating ||
                              e.hasClass(a + "active-slide") ||
                              ((s.direction =
                                s.currentItem < i ? "next" : "prev"),
                              s.flexAnimate(
                                i,
              ...
              touch() {
                      ...
                      (v =
                        p && d && s.animatingTo === s.last
                          ...
                          ? (s.itemW + s.vars.itemMargin) *
                            ...
                            s.currentSlide
                          : d
                          ? (s.last - s.currentSlide + s.cloneOffset) * g
                          : (s.currentSlide + s.cloneOffset) * g),
                      (u = h ? x : T),
                      (f = h ? T : x),
                ...
                function n(t) {
                  (T = t.touches[0].pageX),
                    ...
                    (w = h ? u - x : u - T),
                    (b = h
                      ? Math.abs(w) < Math.abs(T - f)
                      : Math.abs(w) < Math.abs(x - f));
                  var e = 500;
                  (!b || Number(new Date()) - y > e) &&
                    (t.preventDefault(),
                    !m &&
                      s.transitions &&
                      (s.vars.animationLoop ||
                        (w /=
                          (0 === s.currentSlide && 0 > w) ||
                          (s.currentSlide === s.last && w > 0)
                            ? Math.abs(w) / g + 2
                            : 1),
              ...
              smoothHeight(t) {
                if (!h || m) {
                  ...
                  t
                    ...
                    : e.height(s.slides.eq(s.animatingTo).height());
                }
              },
              sync(t) {
                ...
                if (
                  ...
                  p
                    ? ((u = s.vars.itemMargin),
                      ...
                      (g = w > s.limit && 1 !== s.visible ? s.limit : w))
                    : (g =
                        0 === s.currentSlide &&
                        t === s.count - 1 &&
                        s.vars.animationLoop &&
          ...
          s.ready((t) => {
            n("[data-am-flexslider]", t).each((t, e) => {
              var i = n(e),
              ...
              (o.before = function (t) {
                ...
                (o.after = function (t) {
                  ...
                  !e ||
                    ...
                    t.manualPlay ||
                    t.stopped ||
                    (t._pausedTimer = window.setTimeout(() => {
                      t.play();
                    }, e));
                }),
                i.flexslider(o);
    ...
    function (t, e, i) {
      ...
      (n.prototype = {
        ...
        _start(t) {
          if (
            (1 == a.eventType[t.type] || 0 === t.button) &&
            this.enabled &&
      ...
      var s = i(1),
        ...
        c = function (t, e) {
          (this.options = s.extend({}, c.DEFAULTS, e || {})),
            ...
            (this.dimmer = this.options.dimmer ? a : { open() {}, close() {} }),
            this.events();
        };
      (c.DEFAULTS = {
        ...
        (c.prototype.events = function () {
          ...
          this.options.cancelable &&
            ...
            this.options.dimmer &&
              ...
              !this.isLoading &&
              this.dimmer.$element.on("click.dimmer.modal.amui", (t) => {
                e.close();
              }),
            i
              .find("[data-am-modal-close], .am-modal-btn")
              .on("click.close.modal.amui", function (i) {
                i.preventDefault();
                var n = s(this);
                n.is(o)
            ...
            i
              .on("confirm.modal.amui", (t) => {
                (t.data = r()), e.options.onConfirm.call(e, t);
              })
              .on("cancel.modal.amui", (t) => {
      ...
      (c.DEFAULTS = { duration: 300, effect: "overlay" }),
        ...
        (c.prototype.bindEvents = function () {
          ...
          return (
            ...
            this.$element.hammer().on("swipeleft swipeleft", (e) => {
              e.preventDefault(), t.close();
            }),
            this
          );
        ...
        o = function (t) {
          ...
          e.prototype = {
            ...
            getTouches(t) {
              ...
              return Array.prototype.slice.call(t.touches).map((t) => {
          ...
          var s = function (t, e) {
            var i = null,
              ...
              l = function (t) {
                return Array.prototype.slice.call(t).map((t) => {
    ...
    function (t, e, i) {
      ...
      (a.DEFAULTS = {
          ...
          if (e && e.length) {
            ...
            e
              ...
              r - g < h.top + g
                ? (m = u.top - r - g)
                : r < d - h.top - h.height
                ? ((w = "bottom"), (m = u.top + c + a + g))
                : ((w = "middle"), (m = c / 2 + u.top - n / 2)),
              "top" === w || "bottom" === w
                ? ((f = l / 2 + u.left - i / 2),
                  (v = f),
                  5 > f && (f = 5),
        ...
        (a.prototype.getPopover = function () {
          ...
          return (
            this.options.theme &&
              n.each(this.options.theme.split(" "), (t, i) => {
      ...
      (c.DEFAULTS = {
        ...
        (c.prototype.init = function () {
          ...
          this.refreshSlides(),
            ...
            s.find(e.selector.close).on("click.close.pureview.amui", (e) => {
              e.preventDefault(), t.close();
            }),
            this.$slider
              .hammer()
              .on("swipeleft.pureview.amui", (e) => {
                e.preventDefault(), t.nextSlide();
              })
              .on("swiperight.pureview.amui", (e) => {
                e.preventDefault(), t.prevSlide();
              })
              .on("press.pureview.amui", (i) => {
            ...
            i.DOMObserve({ childList: !0, subtree: !0 }, (t, e) => {}),
            i.on("changed.dom.amui", (e) => {
        ...
        (c.prototype.activate = function (t) {
          ...
          i.find("." + r).is(t) ||
            this.transitioning ||
            (this.loadImage(t, () => {
              s.utils.imageLoader(t.find("img"), (e) => {
    ...
    function (t, e, i) {
      ...
      var o = function (t, e) {
        (this.options = n.extend({}, o.DEFAULTS, e)),
          (this.$element = n(t)),
          (this.anchors = []),
          (this.$links = this.$element.find('a[href^="#"]').each((t, e) => {
      ...
      (o.DEFAULTS = {
        ...
        (o.prototype.bindEvents = function () {
          ...
          this.$list.on("click", "> li", function (i) {
            ...
            this.$element.on("validated.field.validator.amui", (e) => {
              if (e.validity) {
            ...
            s.support.mutationobserver &&
              ((this.observer = new s.support.mutationobserver(() => {
    ...
    function (t, e, i) {
      ...
      var c = new l();
      r.on("click.share.amui.data-api", '[data-am-toggle="share"]', (t) => {
    ...
    function (t, e, i) {
      "use strict";
      var n = i(2);
      t.exports = n.intro = { VERSION: "4.0.2", init() {} };
    },
    function (t, e, i) {
      "use strict";
      var n = i(2);
      t.exports = n.listNews = { VERSION: "4.0.0", init() {} };
    },
    function (t, e, i) {
      function n(t) {
    ...
    function (t, e, i) {
      ...
      function n() {
        ...
        function e() {
          return i() >= d
            ? (b.hide(), void y.find("li").insertBefore(b))
        ...
        if (n.length) {
          ...
          d > p && d > i() && t(),
            n.on("click.navbar.amui", ".am-navbar-more", (t) => {
              t.preventDefault(),
                b[y.hasClass(w) ? "removeClass" : "addClass"](w),
                y.toggleClass(w);
            }),
            v.length &&
              v.on("click.navbar.amui", (t) => {
    ...
    function (t, e, i) {
      ...
      function n() {
        ...
        t.not(".am-slider-manual").each((t, e) => {
